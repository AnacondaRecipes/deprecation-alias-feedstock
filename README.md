...
Once the `conda-forge` channel has been enabled, `deprecation-alias` can be installed with:

```
conda install deprecation-alias
```

It is possible to list all of the versions of `deprecation-alias` available on your platform with:
